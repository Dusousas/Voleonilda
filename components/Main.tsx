                ...
                <div className="textwhite maxWidth">
                    ...
                    <div className="text-center mt-4">
                        <motion.button className="bg-GreenS py-2 px-5 rounded font-bold uppercase text-white"
                            initial={{ scale: 0 }}
                            animate={{ scale: 1 }}
                            transition={{ duration: 0.2, delay: 1 }}>Saiba mais</motion.button>
                    </div>
                    ...
                    <motion.div
                        ...
                        initial="hidden"
                        animate="visible">
                        <a href="#"><FontAwesomeIcon className="text-GreenS text-3xl mb-2" icon={faSquareInstagram} /></a>
                        <a href="#"><FontAwesomeIcon className="text-GreenS text-3xl mb-2" icon={faSquareWhatsapp} /></a>
                        <a href="#"><FontAwesomeIcon className="text-GreenS text-3xl mb-2" icon={faSquareFacebook} /></a>
                    </motion.div>
